...
int healingGrasp(TBeing *caster, TBeing * victim, int level, short bKnown, spellNumT spell, int adv_learn)
{
...
int enliven(TBeing *caster, TBeing *victim, int level, short bKnown)
{
  affectedData aff;
