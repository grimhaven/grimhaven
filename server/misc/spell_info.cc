...
// MAGE CLASS
 ...
 discArray[SPELL_DUST_STORM] = new spellInfo(SPELL_MAGE, DISC_MAGE, DISC_AIR, "dust storm", TASK_NORMAL, LAG_1, POSITION_SITTING, MANA_17, LIFEFORCE_0, PRAY_0, TAR_AREA | TAR_FIGHT_VICT | TAR_VIOLENT | TAR_IGNORE, SYMBOL_STRESS_0, "", "", "", "", START_33, LEARN_13, START_DO_40, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.04, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
  ...
  discArray[SPELL_EYES_OF_FERTUMAN] = new spellInfo(SPELL_MAGE, DISC_MAGE, DISC_ALCHEMY, "eyes of Fertuman", TASK_NORMAL, LAG_1, POSITION_CRAWLING, MANA_30, LIFEFORCE_0, PRAY_0, TAR_CHAR_ROOM | TAR_FIGHT_SELF, SYMBOL_STRESS_0, "", "", "", "", START_65, LEARN_13, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.0, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
...
// disc_spirit
  ...
  discArray[SPELL_FUMBLE] = new spellInfo(SPELL_MAGE, DISC_SPIRIT, DISC_SPIRIT, "fumble", TASK_DIFFICULT, LAG_1, POSITION_SITTING, MANA_35, LIFEFORCE_0, PRAY_0, TAR_CHAR_ROOM | TAR_SELF_NONO | TAR_VIOLENT | TAR_FIGHT_VICT, SYMBOL_STRESS_0, "You feel more in control and less clumsy.", "$n stops fumbling about.", "", "", START_60, LEARN_10, START_DO_50, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SPELLS, 0.03, COMP_GESTURAL | COMP_GESTURAL_RANDOM | COMP_VERBAL | COMP_VERBAL_RANDOM | COMP_MATERIAL | COMP_MATERIAL_END | SPELL_TASKED, 0);
...
// disc_warrior
  ...
  discArray[SKILL_DISARM] = new spellInfo(SKILL_WARRIOR, DISC_WARRIOR, DISC_DUELING, "disarm", TASK_DANGEROUS, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_45, LEARN_5, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_dueling
  ...
  discArray[SKILL_RIPOSTE] = new spellInfo(SKILL_WARRIOR, DISC_DUELING, DISC_DUELING, "riposte", TASK_NORMAL, LAG_0, POSITION_DEAD, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2,START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
...
// disc_brawling
  ...
  discArray[SKILL_TAUNT] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, "taunting", TASK_DIFFICULT, LAG_2, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_55, LEARN_4, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_CLOSE_QUARTERS_FIGHTING] = new spellInfo(SKILL_WARRIOR, DISC_BRAWLING, DISC_BRAWLING, "close quarters fighting", TASK_NORMAL, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_85, LEARN_7, START_DO_10, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_karoki
  ...
  discArray[SKILL_BONEBREAK] = new spellInfo(SKILL_MONK, DISC_LEVERAGE, DISC_LEVERAGE, "bonebreak", TASK_NORMAL, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_75, LEARN_4, START_DO_1, LEARN_DO_10, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_DEFENESTRATE] = new spellInfo(SKILL_MONK, DISC_LEVERAGE, DISC_LEVERAGE, "defenestrate", TASK_NORMAL, LAG_4, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2, START_DO_1, LEARN_DO_5, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_advanced_adventuring
  ...
  discArray[SKILL_FISHLORE] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "fishlore", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_TROLLISH] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "trollish", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_BULLYWUGCROAK] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "bullycroak", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_AVIAN] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "avian", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);

  discArray[SKILL_FISHBURBLE] = new spellInfo(SKILL_GENERAL, DISC_ADVANCED_ADVENTURING, DISC_ADVANCED_ADVENTURING, "fish burble", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_50, LEARN_2, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_adventuring
  ...
  discArray[SKILL_LOGGING] = new spellInfo(SKILL_GENERAL, DISC_ADVENTURING, DISC_ADVENTURING, "lumberjack", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_1, LEARN_1, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
  ...
  discArray[SKILL_GUTTER_CANT] = new spellInfo(SKILL_GENERAL, DISC_ADVENTURING, DISC_ADVENTURING, "gutter cant", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_65, LEARN_4, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_GNOLL_JARGON] = new spellInfo(SKILL_GENERAL, DISC_ADVENTURING, DISC_ADVENTURING, "gnoll jargon", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_65, LEARN_4, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);

  discArray[SKILL_TROGLODYTE_PIDGIN] = new spellInfo(SKILL_GENERAL, DISC_ADVENTURING, DISC_ADVENTURING, "troglodyte pidgin", TASK_NORMAL, LAG_0, POSITION_SITTING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_65, LEARN_4, START_DO_25, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_UNUSUAL, 0.0, 0, 0);
...
// disc_theology
  ...
  discArray[SKILL_TURN] = new spellInfo(SKILL_SHAMAN, DISC_SHAMAN_SKUNK, DISC_SHAMAN_SKUNK, "turn", TASK_NORMAL, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_86, LEARN_8, START_DO_1, LEARN_DO_1, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
